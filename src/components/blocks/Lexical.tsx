...
/** Top-level paragraph nodes as plain strings. Used by stat-style blocks
 *  where each paragraph encodes a single item (e.g. "20+ Years Caring"). */
export function lexicalParagraphs(value?: LexicalRoot | null): string[] {
  if (!value?.root?.children) return [];
